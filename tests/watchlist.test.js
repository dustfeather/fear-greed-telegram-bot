...
import { getWatchlist, setWatchlist, addTickerToWatchlist, removeTickerFromWatchlist, ensureTickerInWatchlist } from '../src/utils/watchlist.js';
...
runner.test('Initialize watchlist if missing', async () => {
  ...
  const { initializeWatchlistIfMissing } = await import('../src/utils/watchlist.js');
